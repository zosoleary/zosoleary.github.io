...
BUILDFILE = 'https://pastebin.com/raw/73QbWxYr'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Boognish[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
